...
class Star {
    constructor(cameraZ, cameraTravelDistance) {
        ...
        this.expansionRate = 1.2 + Math.random() * 0.8; // 0.8-1.2 to 1.2-2.0
    ...
    render(p, controller) {
        ...
        if (q > 0) {
            ...
            // Convert 2D screen coords to 3D space
